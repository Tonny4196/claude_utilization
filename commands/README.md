...
### `/customize_agents`
エージェントファイルをプロジェクト固有の情報でカスタマイズ

対話形式でプロジェクト情報を収集し、全エージェントファイルを自動的にカスタマイズします。

**使い方**: `/customize_agents`

### `/mvp-status`
```markdown
[Your Project] MVPの開発状況を確認してください。
...
### `/design-review`
```markdown
[Your Project]の設計ドキュメントをレビューしてください。
