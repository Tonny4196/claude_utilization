...
### 1. React Native プラグイン

React Nativeプロジェクトのサポート。

**plugin-react-native.json**:
```json
{
  "name": "react-native",
  "description": "React Native development support",
  "enabled": true,
  "features": {
    "metro": {
      "enabled": true,
    ...
    "flipper": {
      "enabled": true,
      "plugins": ["react-devtools", "network", "databases"]
    },
    "testing": {
      "jest": true,
      "detox": true
...
**plugin-typescript.json**:
```json
{
  "name": "typescript",
  "description": "TypeScript development support",
  "enabled": true,
  "features": {
    "typeChecking": {
      "strict": true,
...
Supabase開発のサポート（カスタム）。

**plugin-supabase.json**:
```json
{
  "name": "supabase",
...
{
  "name": "testing",
  "description": "Comprehensive testing support",
  "enabled": true,
  "frameworks": {
    "jest": {
      "enabled": true,
